...
Tatoo ("Table Tools") provides three straight-forward helpers to combine multiple
...
You can also direclty override the display parameters saved in the Mashed_table
